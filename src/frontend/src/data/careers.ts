...
export interface CareerData {
  ...
  icon: string;
  title: string;
  category: string; // broad field label
  description: string;
  skills: string[];
  roadmap: RoadmapStep[];
  projects: string[];
...
const answerWeights: Record<string, Record<string, number>> = {
  // Q1: activity
  build: {
    "software-engineer": 3,
    "civil-engineer": 3,
...
export function matchCareers(answers: string[]): string[] {
  ...
  return sorted.length >= 3
    ? sorted.slice(0, 6)
    : Object.keys(careersById).slice(0, 6);
}

export function getMatchScore(careerId: string, answers: string[]): number {
  let score = 0;
  for (const answer of answers) {
    const weights = answerWeights[answer] ?? {};
    score += weights[careerId] ?? 0;
  }
  const maxPossible = 15; // max theoretical score
...
// TECHNOLOGY
const softwareEngineer: CareerData = {
  ...
  description:
    "Craft the digital world — from mobile apps to cloud systems. Software Engineers are the architects of the modern age, turning logic into experiences used by billions.",
  ...
  roadmap: [
    {
      ...
      duration: "2–3 months",
      description:
        "Learn a language (Python or JavaScript). Understand variables, loops, functions, and basic data structures.",
    },
    {
      step: 2,
      ...
      duration: "2–3 months",
      description:
        "Study arrays, linked lists, trees, graphs, sorting, and searching. Solve 100+ problems on LeetCode.",
    },
    {
      step: 3,
      ...
      duration: "3–4 months",
      description:
        "Learn HTML, CSS, React for frontend. Node.js + Express for backend. Deploy your first full-stack project.",
    },
    {
      step: 4,
      ...
      duration: "2–3 months",
      description:
        "Learn system design basics. Create 3–5 production-quality projects and apply for internships.",
    },
  ],
  projects: [
...
const dataScientist: CareerData = {
  id: "data-scientist",
  icon: "📊",
  ...
  description:
    "Turn raw numbers into decisions that move organizations forward. Data Scientists blend statistics, programming, and storytelling to uncover insights hidden in data.",
  ...
  roadmap: [
    {
      ...
      duration: "2 months",
      description:
        "Learn Python basics, NumPy, Pandas. Study descriptive statistics, probability distributions, hypothesis testing.",
    },
    {
      step: 2,
      ...
      duration: "2 months",
      description:
        "Master data cleaning, transformation, and exploration. Build charts with Matplotlib and Seaborn.",
    },
    {
      step: 3,
      ...
      duration: "3 months",
      description:
        "Supervised & unsupervised learning. Linear/logistic regression, decision trees, random forests.",
    },
    {
      step: 4,
      ...
      duration: "Ongoing",
      description:
        "Participate in Kaggle competitions. Build an end-to-end ML project and deploy it.",
    },
  ],
  projects: [
...
const uxDesigner: CareerData = {
  ...
  description:
    "Design experiences that feel effortless. UX Designers are user advocates — they research, prototype, and craft interfaces that connect people with products seamlessly.",
  ...
  roadmap: [
    {
      ...
      duration: "1–2 months",
      description:
        "Learn typography, color theory, layout, and Gestalt principles. Study 10 apps you love and critique their design.",
    },
    {
      step: 2,
      title: "Master Figma",
      duration: "1 month",
      description:
        "Frames, components, auto-layout, prototyping. Recreate 5 existing apps in Figma.",
    },
    {
      step: 3,
      title: "User Research",
      duration: "2 months",
      description:
        "Learn to conduct user interviews, surveys, and usability tests. Practice affinity mapping and persona creation.",
    },
    {
      step: 4,
      ...
      duration: "3 months",
      description:
        "Design 2–3 complete products from research to polished prototype. Document your process for portfolio.",
    },
  ],
  projects: [
...
const graphicDesigner: CareerData = {
  id: "graphic-designer",
  icon: "✏️",
  ...
  description:
    "Give visual form to ideas. Graphic Designers create logos, posters, brand identities, packaging, and digital content that communicate powerfully through images and type.",
  ...
  roadmap: [
    {
      ...
      duration: "2 months",
      description:
        "Learn typography, layout, color theory, and visual hierarchy. Study logo and brand design principles.",
    },
    {
      step: 2,
      ...
      duration: "2 months",
      description:
        "Illustrator for vector design, Photoshop for image editing. Practice daily with design challenges.",
    },
    {
      step: 3,
      ...
      duration: "3 months",
      description:
        "Create logo designs, posters, social media graphics, brand identities. Work on real briefs for local businesses.",
    },
    {
      step: 4,
      ...
      duration: "Ongoing",
      description:
        "List on Fiverr, Upwork, and 99designs. Build a Behance portfolio. Specialize in a niche (branding, packaging, etc.).",
    },
  ],
  projects: [
...
const fashionDesigner: CareerData = {
  id: "fashion-designer",
  icon: "👗",
  ...
  description:
    "Blend art with commerce. Fashion Designers create clothing, accessories, and styling concepts — working across Indian textile traditions and global contemporary trends.",
  ...
  roadmap: [
    {
      ...
      duration: "1–2 months",
      description:
        "Study fashion history, textile science, and garment construction basics. Learn sketching.",
    },
    {
      step: 2,
      ...
      duration: "3 months",
      description:
        "Master pattern making, draping, and sewing. Learn fashion illustration in Adobe Illustrator.",
    },
    {
      step: 3,
      ...
      duration: "3 months",
      description:
        "Design a complete capsule collection with mood boards, fabric swatches, and technical drawings.",
    },
    {
      step: 4,
      ...
      duration: "Ongoing",
      description:
        "Intern with designers or garment exporters. Enter competitions (NIFT, Pearl Academy). Build your portfolio.",
    },
  ],
  projects: [
...
// BUSINESS & COMMERCE
const productManager: CareerData = {
  id: "product-manager",
  icon: "🧩",
  ...
  description:
    "Be the captain of a product. PMs bridge business, design, and engineering — defining what gets built, why, and when, while obsessing over user value and business outcomes.",
  ...
  roadmap: [
    {
      ...
      duration: "2 months",
      description:
        "Read 'Inspired' by Marty Cagan. Understand product-market fit, customer discovery, and product lifecycle.",
    },
    {
      step: 2,
      ...
      duration: "2 months",
      description:
        "Understand DAU, retention, NPS, conversion. Learn SQL basics. Practice with Google Analytics and Mixpanel.",
    },
    {
      step: 3,
      ...
      duration: "1 month",
      description:
        "Learn Scrum, sprint planning, backlog grooming, and user story writing.",
    },
    {
      step: 4,
      title: "Break into PM",
      duration: "Ongoing",
      description:
        "Apply for Associate PM programs. Network on LinkedIn. Build a PM portfolio with case studies.",
    },
  ],
  projects: [
...
const caFinance: CareerData = {
  ...
  description:
    "The financial backbone of every organization. CAs audit accounts, manage taxes, plan finances, and ensure compliance — opening doors at Big 4 firms, banks, and independent practice.",
  ...
  roadmap: [
    {
      ...
      duration: "4–6 months",
      description:
        "Pass the Foundation exam covering Accounting, Business Law, Maths, and Economics. Register with ICAI.",
    },
    {
      step: 2,
      ...
      description:
        "Two groups — Group 1 (Accounting, Laws, Cost Accounting) and Group 2 (Taxation, Auditing, Financial Management).",
    },
    {
      step: 3,
      ...
      duration: "3 years",
      description:
        "Mandatory training under a practising CA. Work in audit, tax, and accounts. This is where practical skills are built.",
    },
    {
      step: 4,
      title: "CA Final",
      duration: "6 months",
      description:
        "Two groups of advanced subjects. Pass all to become a Chartered Accountant. Average pass rate is 10–15%.",
    },
  ],
  projects: [
...
const entrepreneur: CareerData = {
  ...
  description:
    "Chart your own course. Entrepreneurs identify problems, build solutions, and take calculated risks to create value for others — and ultimately, freedom for themselves.",
  ...
  roadmap: [
    {
      ...
      duration: "1–2 months",
      description:
        "Identify a real problem. Talk to 20 potential customers. Use the Mom Test framework. Validate demand first.",
    },
    {
      step: 2,
      ...
      duration: "2–3 months",
      description:
        "Build the smallest version that solves the core problem. Get 10 people to pay for it.",
    },
    {
      step: 3,
      ...
      duration: "Ongoing",
      description:
        "Do things that don't scale: cold emails, events, LinkedIn. Focus on retention before growth.",
    },
    {
      step: 4,
      ...
      duration: "Year 2+",
      description:
        "Double down on what works. Apply to accelerators like Y Combinator, Startup India, 100x.vc.",
    },
  ],
  projects: [
...
const digitalMarketer: CareerData = {
  id: "digital-marketer",
  icon: "📣",
  ...
  description:
    "Own the voice of a brand online. Digital Marketers craft campaigns across SEO, social media, email, and paid ads — to attract, engage, and convert audiences.",
  ...
  roadmap: [
    {
      ...
      duration: "1–2 months",
      description:
        "Understand the 4Ps, customer journey, funnels, and buyer personas.",
    },
    {
      step: 2,
      ...
      duration: "2 months",
      description:
        "Learn keyword research. Understand on-page SEO, backlinks. Start a blog to practice.",
    },
    {
      step: 3,
      ...
      duration: "2 months",
      description:
        "Learn Google Ads and Meta Ads. Understand bidding strategies and A/B testing.",
    },
    {
      step: 4,
      ...
      duration: "Ongoing",
      description:
        "Manage a client's social media pro bono. Apply to agencies or freelance on Upwork.",
    },
  ],
  projects: [
  ...
  resources: [
    ...
    },
    {
      ...
      isFree: true,
      description:
        "Free digital marketing fundamentals with Google certificate.",
    },
    {
...
// GOVERNMENT & LAW
const civilServices: CareerData = {
  id: "civil-services",
  icon: "🏛️",
  ...
  description:
    "Serve the nation at its highest level. The Indian Administrative Service represents one of the most prestigious and impactful careers — shaping policy, infrastructure, and millions of lives.",
  ...
  roadmap: [
    {
      ...
      duration: "1 month",
      description:
        "Study the exam pattern: Prelims (GS + CSAT), Mains (9 papers), and Interview. Choose optional subject.",
    },
    {
      step: 2,
      ...
      duration: "3–4 months",
      description:
        "Read NCERT books for Classes 6–12 in History, Geography, Economics, Political Science, and Science.",
    },
    {
      step: 3,
      ...
      duration: "Ongoing",
      description:
        "Read The Hindu or Indian Express daily. Study Laxmikant, Bipin Chandra, Ramesh Singh.",
    },
    {
      step: 4,
      ...
      duration: "3–6 months",
      description:
        "Write 2 answers daily. Join a test series. Give full-length mock tests weekly.",
    },
  ],
  projects: [
...
const lawyer: CareerData = {
  ...
  description:
    "Uphold justice and navigate the legal system. Lawyers advise clients, argue cases, draft contracts, and specialize in areas from corporate law to human rights advocacy.",
  ...
  roadmap: [
    {
      ...
      duration: "3–5 years",
      description:
        "Complete an LLB from a recognized university. Top options: NLUs, Delhi University Faculty of Law, NALSAR.",
    },
    {
      step: 2,
      ...
      duration: "After LLB",
      description:
        "Enroll with your state Bar Council. Pass the AIBE (All India Bar Examination). This grants you the right to practice.",
    },
    {
      step: 3,
      ...
      duration: "1–3 years",
      description:
        "Work as a junior under a senior advocate or in a law firm. Diverse exposure to courtroom work is crucial.",
    },
    {
      step: 4,
      ...
      duration: "Ongoing",
      description:
        "Specialize in: Corporate Law, Taxation, IP, Family Law, Criminal Law, Human Rights, or Constitutional Law.",
    },
  ],
  projects: [
  ...
  resources: [
    ...
    },
    {
      ...
      isFree: true,
      description:
        "Opportunities, courses, and career guidance for law students.",
    },
    {
...
const doctor: CareerData = {
  ...
  description:
    "Heal, diagnose, and transform lives. Doctors are at the frontline of healthcare — combining deep medical knowledge, empathy, and critical thinking to care for patients.",
  ...
  roadmap: [
    {
      ...
      description:
        "Clear NEET-UG (Physics, Chemistry, Biology). Score high enough for government medical college admission.",
    },
    {
      step: 2,
      ...
      duration: "5.5 years",
      description:
        "Complete MBBS including a 1-year compulsory rotational internship across all major departments.",
    },
    {
      step: 3,
      ...
      duration: "3 years PG",
      description:
        "Appear for NEET-PG to enter a specialization: Medicine, Surgery, Pediatrics, Radiology, etc.",
    },
    {
      step: 4,
      ...
      duration: "Ongoing",
      description:
        "Start independent practice, join a hospital, or pursue DM/MCh super-specialization.",
    },
  ],
  projects: [
...
const nurse: CareerData = {
  ...
  description:
    "Nurses are the backbone of healthcare — providing direct patient care, administering treatments, and bridging the gap between doctors and patients with compassion and expertise.",
  tags: ["care", "people", "empathy", "expert"],
  skills: [
  ...
  roadmap: [
    {
      ...
      duration: "3–4 years",
      description:
        "Complete B.Sc. Nursing (4 years) or GNM Diploma (3.5 years) from an INC-recognized institution.",
    },
    {
      step: 2,
      ...
      description:
        "Register with your State Nursing Council. This is mandatory to practice professionally.",
    },
    {
      step: 3,
      ...
      duration: "2–3 years",
      description:
        "Work in hospitals, clinics, or community health centers. Specialize: ICU, OT, pediatrics, oncology.",
    },
    {
      step: 4,
      ...
      description:
        "Pass NCLEX-RN for USA, NMC CBT for UK, or DHA/MOH for Gulf countries. Global salaries are significantly higher.",
    },
  ],
  projects: [
...
const psychologist: CareerData = {
  ...
  description:
    "Support mental wellbeing and help people navigate life's challenges. Psychologists assess, diagnose, and treat mental health conditions through research-backed therapeutic approaches.",
  ...
  roadmap: [
    {
      ...
      duration: "3 years",
      description:
        "Complete undergraduate psychology. Top colleges: Delhi University, Christ University, Fergusson College.",
    },
    {
      step: 2,
      ...
      duration: "2 years",
      description:
        "Specialize: Clinical Psychology, Counseling, Organizational, or Child Psychology.",
    },
    {
      step: 3,
      ...
      duration: "2+ years",
      description:
        "For clinical practice, complete M.Phil. in Clinical Psychology recognized by the Rehabilitation Council of India (RCI).",
    },
    {
      step: 4,
      ...
      duration: "Ongoing",
      description:
        "Work in hospitals, NGOs, schools, or corporate wellness programs. Register with RCI for independent practice.",
    },
  ],
  projects: [
...
// ARTS & HUMANITIES
const contentCreator: CareerData = {
  id: "content-creator",
  icon: "🎬",
  ...
  description:
    "Build an audience and make a living telling stories. Content Creators produce video, writing, or audio that educates, entertains, and builds genuine communities across platforms.",
  ...
  roadmap: [
    {
      ...
      duration: "1 month",
      description:
        "Identify the intersection of your passion, skill, and audience demand. Commit to one primary platform first.",
    },
    {
      step: 2,
      ...
      duration: "2 months",
      description:
        "Master your smartphone camera, basic lighting, and free editing software (DaVinci Resolve, CapCut).",
    },
    {
      step: 3,
      ...
      duration: "3 months",
      description:
        "Publish every week without fail for 3 months. Study analytics. Double down on what works.",
    },
    {
      step: 4,
      ...
      description:
        "Explore YouTube Partner Program, brand deals, digital products, Patreon, and affiliate marketing.",
    },
  ],
  projects: [
...
const journalist: CareerData = {
  ...
  description:
    "Tell the stories that matter. Journalists investigate, report, and communicate news — holding power accountable and informing the public through print, broadcast, or digital media.",
  ...
  roadmap: [
    {
      ...
      duration: "1–3 years",
      description:
        "Complete B.A. in Journalism, Mass Communication, or an IIMC/ACJ short course. Any field degree works — start writing.",
    },
    {
      step: 2,
      ...
      description:
        "Start a blog. Pitch to student publications, local newspapers, or free platforms (Medium, Substack).",
    },
    {
      step: 3,
      ...
      duration: "3–6 months",
      description:
        "Intern at newspapers, TV channels, or digital outlets. The Wire, NDTV, Times of India all take interns.",
    },
    {
      step: 4,
      ...
      duration: "2–3 years",
      description:
        "Cover a beat: politics, business, technology, sports, culture. Build a network of sources. Develop your voice.",
    },
  ],
  projects: [
...
const writer: CareerData = {
  ...
  description:
    "Craft worlds with words. Writers create fiction, non-fiction, poetry, screenplays, and copy — channeling ideas into language that moves, informs, and inspires readers.",
  ...
  roadmap: [
    {
      ...
      duration: "Ongoing",
      description:
        "Read 50+ books across genres. Study structure, voice, and technique. Read in your genre and outside it.",
    },
    {
      step: 2,
      title: "Write Daily",
      duration: "Ongoing",
      description:
        "Commit to 500–1000 words daily. Keep a journal. Write short stories. Submit to magazines and competitions.",
    },
    {
      step: 3,
      ...
      duration: "3–6 months",
      description:
        "Start a newsletter (Substack) or blog. Share your writing. Build an audience before publishing a book.",
    },
    {
      step: 4,
      ...
      duration: "Variable",
      description:
        "For books: query literary agents (traditional publishing) or self-publish on Amazon KDP. For content writing: freelance immediately.",
    },
  ],
  projects: [
...
const musician: CareerData = {
  ...
  jobOutlook:
    "Multiple career paths; digital distribution enables global reach",
  description:
    "Create and share music that resonates. Musicians compose, perform, record, and teach — building careers across classical Indian music, film, Bollywood, independent music, and international genres.",
  tags: ["create", "story", "creative", "free"],
  skills: [
  ...
  roadmap: [
    {
      ...
      description:
        "Study formally or self-teach. Aim for 10,000 hours of deliberate practice. Join music schools, gurukuls, or online academies.",
    },
    {
      step: 2,
      ...
      duration: "1–2 years",
      description:
        "Understand scales, harmony, and rhythm. Learn a DAW (GarageBand, FL Studio, Logic Pro). Start composing original music.",
    },
    {
      step: 3,
      ...
      duration: "Ongoing",
      description:
        "Record and release music on Spotify, Apple Music, YouTube. Document your journey on social media.",
    },
    {
      step: 4,
      ...
      duration: "Ongoing",
      description:
        "Play at local venues, open mics, and corporate events. Collaborate with other artists. Explore film/jingle scoring.",
    },
  ],
  projects: [
...
const filmmaker: CareerData = {
  ...
  description:
    "Tell visual stories. Filmmakers write scripts, direct actors, and work with crews to create feature films, short films, documentaries, and web series for audiences worldwide.",
  ...
  roadmap: [
    {
      ...
      duration: "1–2 years",
      description:
        "Pursue FTII, SRFTI, or an NID course — OR self-teach through filmmaking YouTube channels and books.",
    },
    {
      step: 2,
      ...
      duration: "Ongoing",
      description:
        "Make 5–10 short films. Submit to festivals. Each film teaches you more than any classroom.",
    },
    {
      step: 3,
      ...
      duration: "2–3 years",
      description:
        "Work as an assistant director (AD) or production assistant on films. The AD route is the traditional Indian industry entry point.",
    },
    {
      step: 4,
      ...
      duration: "Ongoing",
      description:
        "Develop a distinctive visual style. Submit to national and international film festivals. Apply for FD grants.",
    },
  ],
  projects: [
...
const teacher: CareerData = {
  ...
  description:
    "Shape the future one student at a time. Teachers design learning experiences, mentor young minds, and play an irreplaceable role in building the knowledge and character of the next generation.",
  ...
  roadmap: [
    {
      ...
      duration: "3 years",
      description:
        "Complete a B.A./B.Sc./B.Com. in your chosen subject. Strong subject knowledge is the foundation.",
    },
    {
      step: 2,
      ...
      duration: "2 years",
      description:
        "Complete B.Ed. — mandatory for teaching in recognized schools. Covers pedagogy, child development, and teaching practice.",
    },
    {
      step: 3,
      ...
      description:
        "Clear CTET (Central Teacher Eligibility Test) or State TET. This is required for government school teaching positions.",
    },
    {
      step: 4,
      ...
      duration: "Ongoing",
      description:
        "Apply to reputed schools. Or build an online teaching practice via YouTube, Unacademy, Vedantu, or your own platform.",
    },
  ],
  projects: [
  ...
  resources: [
    {
      ...
      isFree: true,
      description:
        "Official NCERT curriculum, textbooks, and teacher resources.",
    },
    {
...
const agronomist: CareerData = {
  ...
  description:
    "Feed the world with science. Agricultural scientists research crops, soil, and farming systems to increase yields, improve sustainability, and transform India's agricultural sector.",
  ...
  roadmap: [
    {
      ...
      duration: "4 years",
      description:
        "Complete B.Sc. Agriculture from state agricultural university or ICAR-affiliated institute.",
    },
    {
      step: 2,
      ...
      duration: "2 years",
      description:
        "Specialize in Agronomy, Plant Breeding, Soil Science, Horticulture, or Agricultural Economics.",
    },
    {
      step: 3,
      ...
      duration: "2–5 years",
      description:
        "Qualify ICAR-JRF to pursue PhD or junior research positions at ICAR institutes and SAUs.",
    },
    {
      step: 4,
      ...
      duration: "3+ years",
      description:
        "Complete PhD for academic/research career OR join agri-business, input companies, or government extension services.",
    },
  ],
  projects: [
  ...
  resources: [
    {
      ...
      isFree: true,
      description:
        "India's apex agricultural research body with free resources.",
    },
    {
...
const socialWorker: CareerData = {
  ...
  description:
    "Create change from the ground up. Social Workers work with vulnerable communities — providing counseling, advocacy, and programs that address poverty, rights, and social justice.",
  ...
  roadmap: [
    {
      ...
      duration: "3 years",
      description:
        "Complete BSW from TISS, Delhi School of Social Work, or similar. Includes mandatory field placements.",
    },
    {
      step: 2,
      ...
      duration: "2 years",
      description:
        "Specialize in: Community Development, Medical Social Work, Family & Child Welfare, or Rural Development.",
    },
    {
      step: 3,
      ...
      duration: "Ongoing",
      description:
        "Volunteer with or intern at NGOs. Build expertise in a specific population or issue area.",
    },
    {
      step: 4,
      ...
      duration: "5+ years",
      description:
        "Move into program management, policy advocacy, or UN agency work. Pursue TISS or overseas fellowships.",
    },
  ],
  projects: [
...
// SPORTS
const sportsAthlete: CareerData = {
  id: "sports-athlete",
  icon: "🏅",
  ...
  description:
    "Turn athletic excellence into a profession. From cricket to chess, kabaddi to athletics — India's sports ecosystem is expanding, opening paths in performance, coaching, management, and sports science.",
  ...
  roadmap: [
    {
      ...
      description:
        "Join a sports academy early. District, state, and national representation builds your profile.",
    },
    {
      step: 2,
      ...
      description:
        "Pursue a degree (Sports Science, Physical Education, or any field). Inter-university sports add credentials.",
    },
    {
      step: 3,
      ...
      duration: "Ongoing",
      description:
        "Participate in Khelo India Games, university tournaments, national trials for your sport.",
    },
    {
      step: 4,
      ...
      description:
        "Move into coaching, sports management, sports journalism, or commentary. Physical Education teaching is a stable option.",
    },
  ],
  projects: [
...
const scientist: CareerData = {
  ...
  description:
    "Push the boundaries of human knowledge. Research Scientists conduct experiments, publish findings, and contribute to the global body of knowledge — from basic science to applied research in industry.",
  ...
  roadmap: [
    {
      ...
      duration: "3 years",
      description:
        "B.Sc. in Physics, Chemistry, Biology, Biotechnology, or related. Aim for a good CGPA and IIT/IISc if possible.",
    },
    {
      step: 2,
      title: "M.Sc. / M.Tech",
      duration: "2 years",
      description:
        "Choose a specialization. IISER, IISc, and IIT postgraduate programs are excellent. Focus on research projects.",
    },
    {
      step: 3,
      ...
      description:
        "Qualify CSIR-NET (JRF) for life sciences or GATE for engineering. This funds your PhD stipend.",
    },
    {
      step: 4,
      ...
      duration: "4–6 years",
      description:
        "Join a research group at IIT, IISc, IISER, or CSIR labs. Publish in international journals.",
    },
  ],
  projects: [
...
const civilEngineer: CareerData = {
  id: "civil-engineer",
  icon: "🏗️",
  ...
  description:
    "Build the world's physical infrastructure. Civil Engineers design, construct, and maintain roads, bridges, dams, buildings, and water systems that form the backbone of civilization.",
  ...
  roadmap: [
    {
      ...
      duration: "4 years",
      description:
        "Complete an AICTE-approved B.Tech in Civil Engineering. JEE/state entrance exams for admission.",
    },
    {
      step: 2,
      ...
      description:
        "Master AutoCAD, STAAD Pro, ETABS, and MS Project. These are industry-standard tools.",
    },
    {
      step: 3,
      ...
      description:
        "Get site experience through internships. Qualify GATE for M.Tech or PSU jobs (NHAI, RVNL, CPWD).",
    },
    {
      step: 4,
      title: "Specialization",
      duration: "2–5 years",
      description:
        "Specialize in: structural, geotechnical, transportation, water resources, or environmental engineering.",
    },
  ],
  projects: [
...
const architect: CareerData = {
  ...
  description:
    "Create spaces where life happens. Architects design buildings, interiors, and urban spaces — blending aesthetics, functionality, and engineering into structures that endure.",
  ...
  roadmap: [
    {
      ...
      duration: "5 years",
      description:
        "Complete B.Arch. from a COA-recognized institution. NATA entrance exam is required for most top schools.",
    },
    {
      step: 2,
      ...
      duration: "During college",
      description:
        "Master AutoCAD, Revit, SketchUp, and rendering tools (Lumion, V-Ray). These are essential for any studio.",
    },
    {
      step: 3,
      ...
      duration: "2 years",
      description:
        "Mandatory architectural experience under a registered architect before COA registration.",
    },
    {
      step: 4,
      ...
      description:
        "Register with the Council of Architecture. Join a firm or start your own practice. Specialize (interior, sustainable, hospitality).",
    },
  ],
  projects: [
...
export const careersById: Record<string, CareerData> = {
...
export const allCareers: CareerData[] = Object.values(careersById);
