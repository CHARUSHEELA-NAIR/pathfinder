import { u as useProgressStore, j as jsxRuntimeExports, m as motion } from "./index-DLmsKBlQ.js";
import { A as AnimatePresence } from "./index-oPS5ip4z.js";
function MarkExploredButton({
  sectionId,
  className = ""
}) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `relative inline-flex ${className}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
      ...
      "aria-label": explored ? "Remove explored mark from this section" : "Mark this section as explored",
      className: [
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: explored && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.span,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: explored ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.span,
          {
